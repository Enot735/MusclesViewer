...
void AIKPawn::BeginPlay()
{
    ...
    // Skeletal mesh
    SkeletalMesh = Cast<USkeletalMeshComponent>(GetDefaultSubobjectByName(TEXT("SkeletalMesh")));
    FVector SocketLocation = SkeletalMesh->GetSocketLocation("hand_lSocket");
}
...
void AIKPawn::CreateJsonByComponent(
    ...
    FVector FinalLocation = Component->GetComponentLocation()
                            - SkeletalMesh->GetSocketLocation(SocketName)
                            - SkeletalMesh->GetSocketLocation(BoneName);
    arrLocation.Add(MakeShareable(new FJsonValueNumber(FinalLocation.X)));
    arrLocation.Add(MakeShareable(new FJsonValueNumber(FinalLocation.Y)));
    arrLocation.Add(MakeShareable(new FJsonValueNumber(FinalLocation.Z)));
...
FString AIKPawn::CreateJson() {
    ...
    // LEFT_HAND
    CreateJsonByComponent(JsonObject, JsonObjectBody, Left_Hand, "LEFT_HAND", "hand_lSocket", "hand_l");
    // LEFT_ELBOW 
    JsonObjectBody = MakeShareable(new FJsonObject);
    CreateJsonByComponent(JsonObject, JsonObjectBody, Left_Elbow, "LEFT_ELBOW", "lowerarm_lSocket", "lowerarm_l");
    // LEFT_SHOULDER
    JsonObjectBody = MakeShareable(new FJsonObject);
    CreateJsonByComponent(JsonObject, JsonObjectBody, Left_Shoulder, "LEFT_SHOULDER", "upperarm_lSocket", "upperarm_l");
    // LEFT_FOOT
    JsonObjectBody = MakeShareable(new FJsonObject);
    CreateJsonByComponent(JsonObject, JsonObjectBody, Left_Foot, "LEFT_FOOT", "foot_lSocket", "foot_l");
    // LEFT_KNEE
    JsonObjectBody = MakeShareable(new FJsonObject);
    CreateJsonByComponent(JsonObject, JsonObjectBody, Left_Knee, "LEFT_KNEE", "calf_lSocket", "calf_l");
    // LEFT_THIGH
    JsonObjectBody = MakeShareable(new FJsonObject);
    CreateJsonByComponent(JsonObject, JsonObjectBody, Left_Thigh, "LEFT_THIGH", "thigh_lSocket", "thigh_l");
    // RIGHT_HAND
    JsonObjectBody = MakeShareable(new FJsonObject);
    CreateJsonByComponent(JsonObject, JsonObjectBody, Right_Hand, "RIGHT_HAND", "hand_rSocket", "hand_r");
    // RIGHT_ELBOW 
    JsonObjectBody = MakeShareable(new FJsonObject);
    CreateJsonByComponent(JsonObject, JsonObjectBody, Right_Elbow, "RIGHT_ELBOW", "lowerarm_rSocket", "lowerarm_r");
    // RIGHT_SHOULDER
    JsonObjectBody = MakeShareable(new FJsonObject);
    CreateJsonByComponent(JsonObject, JsonObjectBody, Right_Shoulder, "RIGHT_SHOULDER", "upperarm_rSocket", "upperarm_r");
    // RIGHT_FOOT
    JsonObjectBody = MakeShareable(new FJsonObject);
    CreateJsonByComponent(JsonObject, JsonObjectBody, Right_Foot, "RIGHT_FOOT", "foot_rSocket", "foot_r");
    // RIGHT_KNEE
    JsonObjectBody = MakeShareable(new FJsonObject);
    CreateJsonByComponent(JsonObject, JsonObjectBody, Right_Knee, "RIGHT_KNEE", "calf_rSocket", "calf_r");
    // RIGHT_THIGH
    JsonObjectBody = MakeShareable(new FJsonObject);
    CreateJsonByComponent(JsonObject, JsonObjectBody, Right_Thigh, "RIGHT_THIGH", "thigh_rSocket", "thigh_l");
